...
\begin{figure}[h]
    ...
    \label{fig:graphhopper-frontend}
\end{figure}

Additionally, GraphHopper supports multiple ``routing profiles" which modify the weights of roads based on the particular vehicle (e.g. car, bike, walking). This is used to prefer certain roads that are more suited for a particular vehicle. 

\td{Contraction Hierarchies}
