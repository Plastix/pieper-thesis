...
Trials were conducted on a \td{Look up machine specs...}
\begin{table}
\begin{center}
\begin{tabular}{|l|l|}
\hline
...
\hline
LS + (Arc Restrictions) & $min\_road\_length=1km$; $min\_road\_score=0.5$  \\
\hline
